...
export default class ReviewForm extends PureComponent {
  constructor() {
    ...
    this.handlerSumbitForm = this.handlerSumbitForm.bind(this);
  }

  handlerSumbitForm(evt) {
    evt.preventDefault();
    evt.target.reset();
  }
  ...
  render() {
    return (
      <form className="reviews__form form" action="#" method="post" onSubmit={this.handlerSumbitForm}>
